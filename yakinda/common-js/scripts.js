...
function countdownTime(){
	...
	if(isExists('#clock')){
		$('#clock').countdown('2018/01/01', function(event){
			var $this = $(this).html(event.strftime(''
				+ '<div class="time-sec"><span class="title">%D</span> gün </div>'
				+ '<div class="time-sec"><span class="title">%H</span> saat </div>'
				+ '<div class="time-sec"><span class="title">%M</span> dakika </div>'
				+ '<div class="time-sec"><span class="title">%S</span> saniye </div>'));
		});
